export const schemas: Record<string, object> = {
  ...
  Product: {
    ...
    properties: {
      _id: { type: 'string' },
      Category: { type: 'string', enum: ['AL_DUHA_LIBRARY', 'CROCHET', 'ANIME', 'HANDMADE'], description: 'Fixed category enum' },
      SubCategory: { type: 'string', enum: ['LIBRARY_PRODUCTS', 'PRINTING_SERVICES'], nullable: true, description: 'Fixed subcategory enum (only for AL_DUHA_LIBRARY)' },
      vendorId: { type: 'string', nullable: true },
    ...
    required: ['Category', 'name', 'slug', 'description', 'stock', 'price'],
  },
  ...
  CreateProductDto: {
    ...
    required: ['Category', 'name', 'slug', 'description', 'stock', 'price'],
    properties: {
      Category: { type: 'string', enum: ['AL_DUHA_LIBRARY', 'CROCHET', 'ANIME', 'HANDMADE'], description: 'Fixed category' },
      SubCategory: { type: 'string', enum: ['LIBRARY_PRODUCTS', 'PRINTING_SERVICES'], nullable: true, description: 'Fixed subcategory (optional, only for AL_DUHA_LIBRARY)' },
      name: { type: 'string', maxLength: 200, example: 'Wireless Headphones' },
      slug: { type: 'string', maxLength: 220, example: 'wireless-headphones' },
      description: { type: 'string', maxLength: 10000 },
      shortDescription: { type: 'string', maxLength: 500 },
